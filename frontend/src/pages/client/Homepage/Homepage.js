...
const Homepage = () => {
  return (
    <>
      <Helmet>
        <title>Claude Airlines - Book Flights, Explore Destinations</title>
        <meta
          name="description"
          content="Claude Airlines is dedicated to providing world-class air travel experiences with modern aircraft, exceptional service, and a commitment to safety and sustainability."
        />
        <meta
          name="keywords"
          content="airline, flights, travel, booking, destinations"
        />
        <link rel="canonical" href="https://claude-airplanes.web.app/home" />
      </Helmet>
