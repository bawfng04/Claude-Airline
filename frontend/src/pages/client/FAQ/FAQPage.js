...
const FAQPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ - Claude Airlines</title>
        <meta
          name="description"
          content="Find answers to the most common questions about our services, booking process, and more."
        />
        <meta
          name="keywords"
          content="FAQ, questions, answers, airline, travel"
        />
        <link rel="canonical" href="https://claude-airplanes.web.app/faq" />
      </Helmet>
      <div className="max-w-[1200px] mt-12 mx-[auto] mb-20 p-8 font-['Segoe_UI',_Arial,_sans-serif] md:p-6 md:mx-[auto] md:my-8">
        ...
        <div className="bg-[linear-gradient(135deg,_#f8f9fa_0%,_#ffffff_100%)] p-12 text-center rounded-[15px] [box-shadow:0_10px_30px_rgba(0,_0,_0,_0.05)] mt-16 animate-[fadeInUp_0.8s_ease-out_forwards] [animation-delay:0.7s] md:p-8">
          <h2 className="mb-4 text-[1.8rem] text-primary-color">
          ...
          <div className="flex justify-center gap-6 flex-wrap">
            <a
              href="/contact"
              className="px-8 py-3.5 text-[white] no-underline rounded-[8px] [transition:all_0.3s_ease] font-semibold inline-block bg-primary-color hover:-translate-y-[3px] hover:[box-shadow:0_5px_15px_rgba(139,_0,_0,_0.2)] hover:bg-primary-light"
            >
              Contact Us
            </a>
            <a
              href="tel:+8490123456"
              className="px-8 py-3.5 no-underline rounded-[8px] [transition:all_0.3s_ease] font-semibold inline-block bg-[white] border-[2px] border-[solid] border-primary-color text-primary-color hover:-translate-y-[3px] hover:[box-shadow:0_5px_15px_rgba(139,_0,_0,_0.2)] hover:bg-primary-color hover:text-[white]"
            >
              Call Us
            </a>
          </div>
