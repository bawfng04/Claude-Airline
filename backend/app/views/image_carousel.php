...
<head>
    ...
    <style>
        ...
        .image-preview-container img {
            max-width: 100px; /* Adjust table preview size */
            max-height: 100px;
            margin-top: 5px;
         ...
         .modal-image-preview img {
            max-width: 200px; /* Adjust modal preview size */
            max-height: 150px;
            margin-top: 10px;
            border: 1px solid #ddd;
            padding: 2px;
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            <!-- Navigation items -->
                             <li class="menu-item">
                                <a href="#" class='menu-link'><span><i class="bi bi-images"></i> Image Carousel</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
