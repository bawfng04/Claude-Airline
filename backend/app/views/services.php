...
<head>
    ...
    <style>
        ...
        .image-preview-container img {
            max-width: 80px; /* Table preview size */
            max-height: 80px;
            margin-top: 5px;
...
<body>
            ...
            <header class="mb-5">
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                             <li class="menu-item">
                                <a href="#" class='menu-link'><span><i class="bi bi-gear-fill"></i> Services Management</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <script>
        $(document).ready(function () {
            ...
            const API_BASE_URL = '/backend/public/Services'; // Controller base
